...
public class BetterSnake extends JPanel implements ActionListener, KeyListener, MouseListener{
	...
	public void optionsNext() {
		if (optionsCursor_y == 90 && optionsCursor_x == 5) {
			...
			appleSpawnRate++;
		}else if (optionsCursor_y == 170 && optionsCursor_x == 5) {
			gameSpeed++;
	...
	public void optionsPrevious() {
		if (optionsCursor_y == 90 && optionsCursor_x == 5 && startSize > 1) {
			...
			appleSpawnRate--;
		}else if (optionsCursor_y == 170 && optionsCursor_x == 5 && gameSpeed > 1) {
			gameSpeed--;
			...
			previousPlayer1Color();
		}else if (optionsCursor_y == 210 && optionsCursor_x == 380) {
			previousPlayer2Color();
		}else if (optionsCursor_y == 250 && optionsCursor_x == 380) {
			previousAppleColor();
		}
	}
	...
	public void previousTextColor() {
		
	}
	public void nextPlayer1Color() {
		
	}
	public void previousPlayer1Color() {
		
	}
	public void nextPlayer2Color() {
		
	}
	public void previousPlayer2Color() {
		
	}
	public void nextAppleColor() {
		
	}
	public void previousAppleColor() {
